        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <p className="text-gray-600">
              At {app.name}, we are committed to protecting your privacy and ensuring you have a positive experience on our website. This policy outlines our practices concerning the collection, use, and disclosure of your information.
            </p>
              ...
              <Card key={index} className="border border-purple-200">
                ...
                >
                  <CardTitle className="text-lg font-semibold text-purple-700 flex justify-between items-center">
                    {policy.title}
                    {expandedSection === index ? <ChevronUp className="h-5 w-5" /> : <ChevronDown className="h-5 w-5" />}
                  </CardTitle>
                </CardHeader>
