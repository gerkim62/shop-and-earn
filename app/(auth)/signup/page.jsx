...
const SignupForm = () => {
  ...
  const referrerName = "John"; // This should be dynamically set based on the actual referrer
  const bonusAmount = "$50"; // This should be dynamically set based on the actual bonus amount
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-100 to-purple-100 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl flex flex-col gap-8">
        <Alert>
          <AlertDescription>
            {referrerName} has invited you to create an account. You and {referrerName} will earn a {bonusAmount} bonus when you create an account. 
          </AlertDescription>
        </Alert>
